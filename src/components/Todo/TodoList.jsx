...
import { deleteTodo, updateTodo } from "@src/slices/todoSlice";
                ...
                <div className="">
                    <Card className="xl:col-span-2">
                        <CardHeader className="flex flex-row items-center">
                            ...
                            <AddTodo open={open} setEdit={setEditable} setOpen={setOpen} isEdit={editable} task={task}/>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                <TableHeader>
                                        ...
                                        <TableRow key={todo.id}>
                                            ...
                                            <TableCell className="text-foreground">
                                                <div className="flex flex-grow gap-2 items-center">
                                                    <Button size="icons" className="" icon={<MdEdit className="text-2xl m-2 " />} onClick={() => handleEdit(todo.id, todo)}></Button>
                                                    <Button
                                                        size="icons"
